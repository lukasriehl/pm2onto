...
public class ProcessType {
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "DataAssociations", namespace = "http://www.wfmc.org/2009/XPDL2.2", type = DataAssociations.class),
        @XmlElementRef(name = "DataObjects", namespace = "http://www.wfmc.org/2009/XPDL2.2", type = DataObjects.class),
        @XmlElementRef(name = "RedefinableHeader", namespace = "http://www.wfmc.org/2009/XPDL2.2", type = RedefinableHeader.class),
        @XmlElementRef(name = "DataFields", namespace = "http://www.wfmc.org/2009/XPDL2.2", type = org.wfmc._2009.xpdl2.DataFields.class),
        @XmlElementRef(name = "Transitions", namespace = "http://www.wfmc.org/2009/XPDL2.2", type = Transitions.class),
        @XmlElementRef(name = "Activities", namespace = "http://www.wfmc.org/2009/XPDL2.2", type = Activities.class),
        @XmlElementRef(name = "Applications", namespace = "http://www.wfmc.org/2009/XPDL2.2", type = org.wfmc._2009.xpdl2.Applications.class),
        @XmlElementRef(name = "PartnerLinks", namespace = "http://www.wfmc.org/2009/XPDL2.2", type = PartnerLinks.class),
        @XmlElementRef(name = "Applications", namespace = "http://www.wfmc.org/2002/XPDL1.0", type = org.wfmc._2002.xpdl1.Applications.class),
        @XmlElementRef(name = "ProcessHeader", namespace = "http://www.wfmc.org/2009/XPDL2.2", type = ProcessHeader.class),
        @XmlElementRef(name = "ActivitySets", namespace = "http://www.wfmc.org/2009/XPDL2.2", type = ActivitySets.class),
        @XmlElementRef(name = "DataInputOutputs", namespace = "http://www.wfmc.org/2009/XPDL2.2", type = DataInputOutputs.class),
        @XmlElementRef(name = "DataStoreReferences", namespace = "http://www.wfmc.org/2009/XPDL2.2", type = DataStoreReferences.class),
        @XmlElementRef(name = "InputSets", namespace = "http://www.wfmc.org/2009/XPDL2.2", type = InputSets.class),
        @XmlElementRef(name = "Participants", namespace = "http://www.wfmc.org/2009/XPDL2.2", type = org.wfmc._2009.xpdl2.Participants.class),
     ...
     * line 2466 of file:/D:/TESTE/ImportaXML2/src/br/com/fernando/importaxml/base/9999-bpmnxpdl_40a.xsd
     * line 2463 of file:/D:/TESTE/ImportaXML2/src/br/com/fernando/importaxml/base/9999-bpmnxpdl_40a.xsd
     * <p>
