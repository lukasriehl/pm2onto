 ...
 *       &lt;/sequence>
 *       &lt;attribute name="DataStoreRef" use="required" type="{http://www.wfmc.org/2009/XPDL2.2}IdRef" />
...
@XmlRootElement(name = "DataStoreReference")
public class DataStoreReference {
    ...
    @XmlAttribute(name = "DataStoreRef", required = true)
     ...
     *     
     */
    public void setDataStoreRef(String value) {
